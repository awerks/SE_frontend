...
export function setupModal() 
{
  ...
  if (!overlay || !openBtn || !closeBtn) return;//error checking, might wanna add an error message later
...
//LEAVE COMMENTED, it was generated by chat gpt and (ofc) it does NOT work
/*
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if(!document.querySelector('.teamspace_page')) return;
